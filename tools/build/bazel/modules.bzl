...
APP_JAR_MAP = {
    ...
    "//apps/ONOS_LoadBalance_Routing_Forward:onos-apps-ONOS_LoadBalance_Routing_Forward": [],
    "//apps/ngsdn:onos-apps-ngsdn": [],
    #    "//apps/int2_over_ipv6:onos-apps-int2_over_ipv6": [],
...
APP_MAP = {
    ...
    # "//apps/int2_over_ipv6:onos-apps-int2_over_ipv6-oar": [],
    ...
    "//apps/ngsdn:onos-apps-ngsdn-oar": [],
