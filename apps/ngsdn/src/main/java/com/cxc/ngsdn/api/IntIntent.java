...
public final class IntIntent {
    ...
    private Set<ConnectPoint> sourceCPs;
    private Set<ConnectPoint>  sinkCPs;
...
//                      TelemetryMode telemetryMode, IntConfig intConfig) {
...
//    }
        ...
        private IntIntent(Builder builder) {
            this.selector = builder.selector;
            this.metadataTypes = builder.metadataTypes;
            this.headerType = builder.headerType;
            this.reportTypes = builder.reportTypes;
            this.telemetryMode = builder.telemetryMode;
            this.intConfig = builder.intConfig;
            this.setSourceCPs(builder.sourceCPs);
            this.setSinkCPs(builder.sinkCPs);
        }


    public Set<ConnectPoint> getSourceCPs() {
        return sourceCPs;
    }

    public void setSourceCPs(Set<ConnectPoint> sourceCPs) {
        this.sourceCPs = sourceCPs;
    }

    public Set<ConnectPoint> getSinkCPs() {
        return sinkCPs;
    }

    public void setSinkCPs(Set<ConnectPoint> sinkCPs) {
        this.sinkCPs = sinkCPs;
    }
    ...
    public IntObjective getIntObjectives() {
        return new IntObjective.Builder()
                .withSelector(this.selector())
                .withMetadataTypes(this.metadataTypes())
                .withHeaderType(this.headerType())
                .build();
    }
    ...
    public static final class Builder {
        ...
        private IntConfig intConfig ;
        private Set<ConnectPoint> sourceCPs = new HashSet<>();
        private Set<ConnectPoint> sinkCPs = new HashSet<>();
        ...
        public Builder withIntConfig(IntConfig intConfig) {
            this.intConfig = intConfig;
            return this;
        }

        public Builder withSourceCP(ConnectPoint sourceCP) {
            this.sourceCPs.add(sourceCP);
            return this;
        }

        public Builder withSourceCPs(Set<ConnectPoint> sourceCPs) {
            this.sourceCPs= sourceCPs;
            return this;
        }

        public Builder withSinkCP(ConnectPoint sinkCP) {
            this.sinkCPs.add(sinkCP);
            return this;
        }

        public Builder withSinkCPs(Set<ConnectPoint> sinkCPs) {
            this.sinkCPs= sinkCPs;
            return this;
        }
...
//            checkNotNull(this.intConfig, "int telemetry config can not be empty");

            return new IntIntent(this);
//            return new IntIntent(selector, metadataTypes, headerType, reportTypes, telemetryMode, this.intConfig);
        }
    }
}
