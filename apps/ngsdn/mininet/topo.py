...
from bmv2 import ONOSBmv2Switch,ONOSStratumSwitch, ONOSHost
...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # All routers
        # gRPC port 50001
        r1 = self.addSwitch('r1', cls=ONOSBmv2Switch,  grpcport=50001, pipeconf="com.cxc.ngsdn",cpuport=CPU_PORT)
        # gRPC port 50002
        r2 = self.addSwitch('r2', cls=ONOSBmv2Switch, grpcport=50002,pipeconf="com.cxc.ngsdn",cpuport=CPU_PORT)
        # gRPC port 50003
        r3 = self.addSwitch('r3', cls=ONOSBmv2Switch, grpcport=50003,pipeconf="com.cxc.ngsdn",cpuport=CPU_PORT)
        # gRPC port 50004
        r4 = self.addSwitch('r4', cls=ONOSBmv2Switch,grpcport=50004,pipeconf="com.cxc.ngsdn", cpuport=CPU_PORT)
        # gRPC port 50005
        r5 = self.addSwitch('r5', cls=ONOSBmv2Switch, grpcport=50005,pipeconf="com.cxc.ngsdn",cpuport=CPU_PORT)
        # gRPC port 50006
        r6 = self.addSwitch('r6', cls=ONOSBmv2Switch,grpcport=50006,pipeconf="com.cxc.ngsdn", cpuport=CPU_PORT)
        # r6 = self.addSwitch('r6', cls=ONOSStratumSwitch,grpcport=50006,pipeconf="com.cxc.ngsdn", cpuport=CPU_PORT)
